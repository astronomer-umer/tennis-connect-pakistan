...
export const metadata = {
  title: "Terms of Service | Tennis Connect Pakistan",
  description: "Terms of Service for Tennis Connect Pakistan",
};
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-foreground/90">
          <section>
            ...
            <p className="text-sm">
              By accessing and using Tennis Connect Pakistan, you accept and agree to be bound by the terms and provision of this agreement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              Permission is granted to temporarily use Tennis Connect Pakistan for personal, non-commercial use only. This is the grant of a license, not a transfer of title.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              Tennis Connect Pakistan shall not be liable for any indirect, incidental, or consequential damages arising out of your use of the app.
            </p>
          </section>
